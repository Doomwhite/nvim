function setup()
	...
	function setup_normal()
		...
		wk.register({
			...
			["<leader>P"] = KB(":lua CopySystemClipboardToRegister()<CR>", "Executes the compiler with the C++ standard", true, false, false),
			...
			-- ["<leader>w1"] = KB("<Plug>(cokeline-focus-1)", "Go to buffer 1", true, false, false),
			-- ["<leader>w2"] = KB("<Plug>(cokeline-focus-2)", "Go to buffer 1", true, false, false),
			-- ["<leader>w3"] = KB("<Plug>(cokeline-focus-3)", "Go to buffer 1", true, false, false),
			-- ["<leader>w4"] = KB("<Plug>(cokeline-focus-4)", "Go to buffer 1", true, false, false),
			-- ["<leader>w5"] = KB("<Plug>(cokeline-focus-5)", "Go to buffer 1", true, false, false),
			-- ["<leader>w6"] = KB("<Plug>(cokeline-focus-6)", "Go to buffer 1", true, false, false),
			-- ["<leader>w7"] = KB("<Plug>(cokeline-focus-7)", "Go to buffer 1", true, false, false),
			-- ["<leader>w8"] = KB("<Plug>(cokeline-focus-8)", "Go to buffer 1", true, false, false),
			-- ["<leader>w9"] = KB("<Plug>(cokeline-focus-9)", "Go to buffer 1", true, false, false),
			-- ["<leader>wf"] = KB("<Plug>(cokeline-focus-i)", "Focuses a buffer", true, false, false),
			-- ["<leader>ws"] = KB("<Plug>(cokeline-switch-i)", "Switches the buffer pos", true, false, false),
			-- ["<leader>wd"] = KB("<Plug>(cokeline-pick-close)", "Pick a buffer to delete", true, false, false),
			...
			["g1"] = KB("<Plug>(cokeline-focus-1)", "Go to buffer 1", false, false, false),
			["g2"] = KB("<Plug>(cokeline-focus-2)", "Go to buffer 1", false, false, false),
			["g3"] = KB("<Plug>(cokeline-focus-3)", "Go to buffer 1", false, false, false),
			["g4"] = KB("<Plug>(cokeline-focus-4)", "Go to buffer 1", false, false, false),
			["g5"] = KB("<Plug>(cokeline-focus-5)", "Go to buffer 1", false, false, false),
			["g6"] = KB("<Plug>(cokeline-focus-6)", "Go to buffer 1", false, false, false),
			["g7"] = KB("<Plug>(cokeline-focus-7)", "Go to buffer 1", false, false, false),
			["g8"] = KB("<Plug>(cokeline-focus-8)", "Go to buffer 1", false, false, false),
			["g9"] = KB("<Plug>(cokeline-focus-9)", "Go to buffer 1", false, false, false),

			["gw"] = { name = "Window/Buffer" },
			["gws1"] = KB("<Plug>(cokeline-switch-1)", "Switches the buffer to 1", false, false, false),
			["gws2"] = KB("<Plug>(cokeline-switch-2)", "Switches the buffer to 2", false, false, false),
			["gws3"] = KB("<Plug>(cokeline-switch-3)", "Switches the buffer to 3", false, false, false),
			["gws4"] = KB("<Plug>(cokeline-switch-4)", "Switches the buffer to 4", false, false, false),
			["gws5"] = KB("<Plug>(cokeline-switch-5)", "Switches the buffer to 5", false, false, false),
			["gws6"] = KB("<Plug>(cokeline-switch-6)", "Switches the buffer to 6", false, false, false),
			["gws7"] = KB("<Plug>(cokeline-switch-7)", "Switches the buffer to 7", false, false, false),
			["gws8"] = KB("<Plug>(cokeline-switch-8)", "Switches the buffer to 8", false, false, false),
			["gws9"] = KB("<Plug>(cokeline-switch-9)", "Switches the buffer to 9", false, false, false),
			["gwf"] = KB("<Plug>(cokeline-pick-focus)", "Focuses a buffer", false, false, false),
			["gwd"] = KB("<Plug>(cokeline-pick-close)", "Pick a buffer to delete", false, false, false),
